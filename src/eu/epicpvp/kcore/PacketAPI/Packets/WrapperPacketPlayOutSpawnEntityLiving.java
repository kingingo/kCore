...
public class WrapperPacketPlayOutSpawnEntityLiving implements PacketWrapper{
	...
	public WrapperPacketPlayOutSpawnEntityLiving(PacketPlayOutSpawnEntityLiving packet){
		this.packet = packet;
	}
	
	public WrapperPacketPlayOutSpawnEntityLiving(){
		this(new PacketPlayOutSpawnEntityLiving());
	}
	
	public WrapperPacketPlayOutSpawnEntityLiving(int entityID ,EntityType type ,Location location){
	...
	public WrapperPacketPlayOutSpawnEntityLiving(EntityLiving living){
