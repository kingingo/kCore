...
public class WrapperPacketPlayInUseEntity implements PacketWrapper{
	@Getter
	...
	public WrapperPacketPlayInUseEntity(PacketPlayInUseEntity packet){
		this.packet=packet;
	}
	
	public WrapperPacketPlayInUseEntity(Object packet){
