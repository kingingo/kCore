...
public class WrapperPacketPlayOutScoreboardTeam implements PacketWrapper{
	@Getter
	...
	public WrapperPacketPlayOutScoreboardTeam(){
		this.packet=new PacketPlayOutScoreboardTeam();
	}
	
	public WrapperPacketPlayOutScoreboardTeam(PacketPlayOutScoreboardTeam packet){
		this.packet=packet;
	}
	
	public WrapperPacketPlayOutScoreboardTeam(String name,String prefix,int mode,String player){
	...
	public WrapperPacketPlayOutScoreboardTeam(String name,String prefix,int mode,Player player){
		packet=new PacketPlayOutScoreboardTeam();
		setDisplayname(name);
		setTeamName(name);
		setPrefix(prefix);
	...
	public WrapperPacketPlayOutScoreboardTeam(String name,String prefix,String suffix,int mode,String player){
		packet=new PacketPlayOutScoreboardTeam();
		setDisplayname(name);
		setTeamName(name);
		setSuffix(suffix);
	...
	public WrapperPacketPlayOutScoreboardTeam(String name,String prefix,String suffix,int mode,Player player){
		packet=new PacketPlayOutScoreboardTeam();
		setDisplayname(name);
		setTeamName(name);
		setSuffix(suffix);
