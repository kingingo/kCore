...
public class WrapperPacketPlayOutEntityVelocity implements PacketWrapper{
	@Getter
	@Setter
	...
	public WrapperPacketPlayOutEntityVelocity(){
		this.packet=new PacketPlayOutEntityVelocity();
	}
	
	public WrapperPacketPlayOutEntityVelocity(PacketPlayOutEntityVelocity packet){
		this.packet=packet;
	}
