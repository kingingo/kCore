...
public class WrapperPacketPlayOutNamedEntitySpawn implements PacketWrapper{
	@Getter
	@Setter
	...
	public WrapperPacketPlayOutNamedEntitySpawn(){
		this(new PacketPlayOutNamedEntitySpawn());
	}
	
	public WrapperPacketPlayOutNamedEntitySpawn(PacketPlayOutNamedEntitySpawn packet){
		this.packet = packet;
	}
	
	public WrapperPacketPlayOutNamedEntitySpawn(EntityHuman human){
