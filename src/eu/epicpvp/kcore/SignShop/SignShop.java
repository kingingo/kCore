					...
					for(Player player : UtilServer.getPlayers())
						if(player.hasPermission(PermissionType.SHOP_SIGN_CREATE_MSG.getPermissionToString())){
							...
							for(String line : ev.getLines()){
								player.sendMessage(TranslationHandler.getText(player,"PREFIX")+line);
							}
	    				...
	    				if(event.isCancelled())return;
	                		...
	                		if(p.isSneaking()){
	                			...
	                			if(sign.getLine(3).contains(":")){
	            					...
	            					p.sendMessage(TranslationHandler.getText(p, "PREFIX")+TranslationHandler.getText(p, "SIGN_SHOP_GET_",new String[]{"32",String.valueOf(id),idnach,String.valueOf(Preis)}));
	            				...
	            				p.getInventory().addItem(i);
	        					p.updateInventory();
	        					p.sendMessage(TranslationHandler.getText(p, "PREFIX")+TranslationHandler.getText(p, "SIGN_SHOP_GET",new String[]{"32", String.valueOf(id),String.valueOf(Preis)}));
	        					getStatsmanager().setDouble(p, getStatsmanager().getDouble(StatsKey.MONEY, p)-Preis, StatsKey.MONEY);
	                		...
	                		if(sign.getLine(3).contains(":")){
	            				...
	            				p.getInventory().addItem(i);
	        					p.updateInventory();
	        					p.sendMessage(TranslationHandler.getText(p, "PREFIX")+TranslationHandler.getText(p, "SIGN_SHOP_GET_",new String[]{String.valueOf(anzahl),String.valueOf(id),idnach,String.valueOf(Preis)}));
	        					getStatsmanager().setDouble(p, getStatsmanager().getDouble(StatsKey.MONEY, p)-Preis, StatsKey.MONEY);
	    					...
	    					p.sendMessage(TranslationHandler.getText(p, "PREFIX")+TranslationHandler.getText(p, "SIGN_SHOP_GET",new String[]{String.valueOf(anzahl),String.valueOf(id),String.valueOf(Preis)}));
	    					getStatsmanager().setDouble(p, getStatsmanager().getDouble(StatsKey.MONEY, p)-Preis, StatsKey.MONEY);
	                ...
	                if(sign.getLine(0).equalsIgnoreCase(ChatColor.AQUA+"[shop]")||sign.getLine(0).equalsIgnoreCase(ChatColor.AQUA+"[shop-buy]")||sign.getLine(0).equalsIgnoreCase(ChatColor.AQUA+"[shop-sale]")){
	                	...
	                	if(p.isSneaking()){
	                		...
	                		if(sign.getLine(3).contains(":")){
	        					...
	        					p.sendMessage(TranslationHandler.getText(p, "PREFIX")+TranslationHandler.getText(p, "SIGN_SHOP_VERKAUFT_",new String[]{String.valueOf(b),String.valueOf(id),idnach,String.valueOf(VerkaufPreis)}));
	            		...
	            		if(sign.getLine(3).contains(":")){
	        				...
	        				p.sendMessage(TranslationHandler.getText(p, "PREFIX")+TranslationHandler.getText(p, "SIGN_SHOP_VERKAUFT_",new String[]{String.valueOf(anzahl),String.valueOf(id),idnach,String.valueOf(VerkaufPreis)}));
	        				getStatsmanager().setDouble(p, getStatsmanager().getDouble(StatsKey.MONEY, p)+VerkaufPreis, StatsKey.MONEY);
