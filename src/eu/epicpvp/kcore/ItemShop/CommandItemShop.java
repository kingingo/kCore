			...
			if(player.hasPermission(PermissionType.ALL_PERMISSION.getPermissionToString())){
				if(args[0].equalsIgnoreCase("addc")){
					...
					if(args.length==6){
						...
						hand=UtilItem.setLore(hand, new String[]{"§7"+Zeichen.DOUBLE_ARROWS_R.getIcon()+" §cBuy","§7-","§e1 "+Zeichen.DOUBLE_ARROWS_R.getIcon()+" §a"+UtilNumber.toInt(args[3])+" Epics","§e10 "+Zeichen.DOUBLE_ARROWS_R.getIcon()+" §a"+(UtilNumber.toInt(args[3])*10)+" Epics","§e64 "+Zeichen.DOUBLE_ARROWS_R.getIcon()+" §a"+(UtilNumber.toInt(args[3])*64)+" Epics","§7----------","§7"+Zeichen.DOUBLE_ARROWS_R.getIcon()+" §cSell","§7-","§e1 "+Zeichen.DOUBLE_ARROWS_R.getIcon()+" §a"+UtilNumber.toInt(args[4])+" Epics","§e10 "+Zeichen.DOUBLE_ARROWS_R.getIcon()+" §a"+(UtilNumber.toInt(args[4])*10)+" Epics","§e64 "+Zeichen.DOUBLE_ARROWS_R.getIcon()+" §a"+(UtilNumber.toInt(args[4])*64)+" Epics"});
						...
						ItemStack hand = player.getItemInHand();
						hand=UtilItem.setLore(hand, new String[]{"§7§ §cBuy","§7-","§e1 § §a"+UtilNumber.toInt(args[2])+" Epics","§e10 § §a"+(UtilNumber.toInt(args[2])*10)+" Epics","§e64 § §a"+(UtilNumber.toInt(args[2])*64)+" Epics","§7----------","§7§ §cSell","§7-","§e1 § §a"+UtilNumber.toInt(args[3])+" Epics","§e10 § §a"+(UtilNumber.toInt(args[3])*10)+" Epics","§e64 § §a"+(UtilNumber.toInt(args[3])*64)+" Epics"});
