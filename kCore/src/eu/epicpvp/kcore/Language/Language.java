...
//		packetManager.SendPacket("BG", new PLAYER_LANGUAGE_CHANGE(UtilPlayer.getRealUUID(player), type));
	...
	public static void addAll(LanguageType type){
		...
		if(type==LanguageType.GERMAN){
	        ...
	        add(type, "VOTE_THX", "§aDanke fÃ¼rs §a§lVoten§a du hast deine Belohnung erhalten!");
			add(type, "ANIT_LOGOUT_FIGHT_CMD", "§cDu kannst den Befehl §e{INPUT0}§c nicht im Kampf ausfÃ¼hren!");
			add(type, "ANIT_LOGOUT_FIGHT", "§cDu kannst dich im Kampf nicht teleportieren!");
			add(type,"XMAS_DOOR","§aDu hast das TÃ¼rchen geÃ¶ffnet und §e{INPUT0}§a Coins und §e{INPUT1}§a Gems erhalten!");
			...
			add(type,"XMAS_DAY","§cIst heute der {INPUT0}te?");
			add(type,"LOGIN_FAIL","§cUngÃ¼ltiges Zeichen!");
			...
			add(type,"GILDE_CMD7","§6/gilde info [Gilde] §8|§7 Zeigt Infos Ã¼ber eine Gilde.");
			...
			add(type,"SKYBLOCK_CMD2","§6/skyblock entfernen §8|§7 LÃ¶sche deine Insel.");
			...
			add(type,"SKYBLOCK_CMD9","§6/homedelete [Player] §8|§7 LÃ¶schen von Homes auf deiner Insel.");
			...
			add(type,"GAME_HOLOGRAM_BEDWARS","Betten ZerstÃ¶rt: {INPUT0}");
			...
			add(type,"GAME_HOLOGRAM_SHEEP","getÃ¶tete Schafe: {INPUT0}");
			add(type,"GAME_HOLOGRAM_STATS","§a{INPUT0} §6§l Stats");
			add(type,"GAME_HOLOGRAM_POWER","Power: {INPUT0}");
			add(type,"GAME_HOLOGRAM_KARMA","Karma: {INPUT0}");
			add(type,"GAME_HOLOGRAM_TESTS","Tests: {INPUT0}");
			...
			add(type,"TWITTER_ACC_NOT","§cDu hast noch keinen Twitter Account hinzugefÃ¼gt!");
			...
			add(type,"NEAR_FIND","§aDer Spieler §7{INPUT1}§a ist §7{INPUT2}§a BlÃ¶cke entfernt!");
			...
			add(type,"GUNGAME_KILL","§7Du hast §a{INPUT0} §7getÃ¶tet.");
			add(type,"GUNGAME_KILLED_BY","§cDu wurdest von §e{INPUT0} §cgetÃ¶tet.");
