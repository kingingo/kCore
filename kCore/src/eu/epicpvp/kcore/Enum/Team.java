...
GREEN("GREEN",UtilItem.RenameItem(new ItemStack(Material.WOOL,1,(byte)13), Color.GREEN+"Team - Gr§n"),Color.GREEN),
...
WHITE("WHITE",UtilItem.RenameItem(new ItemStack(Material.WOOL,1), Color.WHITE+"Team - Wei§"),Color.WHITE),
...
LIME("LIME",UtilItem.RenameItem(new ItemStack(Material.WOOL,1,(byte)5), Color.GRAY+"Team - Hell Gr§n"),"§a"),
...
VILLAGE_GREEN("VILLAGE_GREEN",UtilItem.RenameItem(new ItemStack(Material.WOOL,1,(byte)5), Color.GREEN+"Villager - Gr§n"),Color.GREEN),
...
VILLAGE_LIME("VILLAGE_LIME",UtilItem.RenameItem(new ItemStack(Material.WOOL,1,(byte)5), Color.GRAY+"Villager - Hell Gr§n"),"§a"),
...
SHEEP_GREEN("SHEEP_GREEN",UtilItem.RenameItem(new ItemStack(Material.WOOL,1,(byte)5), Color.GREEN+"Sheep - Gr§n"),Color.GREEN),
...
SHEEP_WHITE("SHEEP_WHITE", UtilItem.RenameItem(new ItemStack(Material.WOOL,1,(byte)10), Color.WHITE+"Sheep - Wei§"),Color.WHITE),
...
SHEEP_LIME("SHEEP_LIME",UtilItem.RenameItem(new ItemStack(Material.WOOL,1,(byte)5), "§aSheep - Hell Gr§n"),"§a"),
