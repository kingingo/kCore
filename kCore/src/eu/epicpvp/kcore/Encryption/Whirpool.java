package eu.epicpvp.kcore.Encryption;
...
class Whirlpool {
    ...
    protected static byte[] bitLength = new byte[32];

    protected static byte[] buffer = new byte[64];

    protected static int bufferBits = 0;

    protected static int bufferPos = 0;

    protected static long[] hash  = new long[8];
    protected static long[] K     = new long[8]; 
    protected static long[] L     = new long[8];
    protected static long[] block = new long[8]; 
    protected static long[] state = new long[8];

    protected static void processBuffer() {
    ...
    public static void NESSIEadd(byte[] source, long sourceBits) {
        int sourcePos = 0; 
    ...
    public static void NESSIEfinalize(byte[] digest) {
    ...
    public static void NESSIEadd(String source) {
        if (source.length() > 0) {
