...
ENDER_DRAGON("EnderDragon", 63, EntityType.ENDER_DRAGON, EntityEnderDragon.class, kEnderdragon.class);
...
private kEntityType(String name, int id, EntityType entityType, Class<? extends EntityInsentient> nmsClass,
