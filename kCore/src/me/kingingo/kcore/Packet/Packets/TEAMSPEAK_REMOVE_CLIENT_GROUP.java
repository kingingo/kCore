...
public class TEAMSPEAK_REMOVE_CLIENT_GROUP extends Packet{
	...
	public TEAMSPEAK_REMOVE_CLIENT_GROUP(String identität,int groupId,String inGameName){
		this.identität=identität;
		this.groupId=groupId;
		this.inGameName=inGameName;
	}
	
	public TEAMSPEAK_REMOVE_CLIENT_GROUP(String identität,TeamspeakGroup group,String inGameName){
		this.identität=identität;
	...
	//TEAMSPEAK_ADD_CLIENT_GROUP-/-IDENTITÄT-/-groupId-/-InGame
