...
TTT_PÄSSE_USE("Du hast einen % Pass benutzt du hast jetzt noch %!"),
TTT_PÄSSE_KEINE("Du besitzt keine % Pässe!"),
TTT_PÄSSE_LOBBYPHASE("Die LobbyPhase ist vorbei..."),
TTT_PÄSSE_MAX_USED("Es wurden schon zu viele % Pässe benutzt"),
