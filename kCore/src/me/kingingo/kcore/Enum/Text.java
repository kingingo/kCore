...
GILDE_CREATE("§aDu hast erfolgreich die Gilde§6 %§a gegründet! Dein Golden Home wurde auf deine aktuelle Position gesetzt."),
...
GILDE_PLAYER_ENTRE("§aDie Gilde wurde von§b %§a betretten."),
...
GILDE_PLAYER_JOIN("§a%§b hat den Server betretten."),
