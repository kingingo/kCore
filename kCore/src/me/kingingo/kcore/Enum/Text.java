...
SKYBLOCK_PARTY_IN("§cDu bist bereits in einer Party. Tippe §7/Skyblock party verlassen§a um sie wieder zu verlassen!"),
SKYBLOCK_PARTY_EINLADEN_NO("§cDu wurdest in keine Party eingeladen."),
SKYBLOCK_PARTY_ENTER("§aDu hast die Party betretten!"),
SKYBLOCK_PARTY_ENTER_BY("§aDer Spieler§b %§a hat die Party betretten."),
SKYBLOCK_PARTY_SIZE("§cDu kannst maximal§b %§c Spieler in deine Party einladen."),
SKYBLOCK_PARTY_VOLL("§cDie Party ist voll!"),
SKYBLOCK_PARTY_EINLADEN_INVITE("§aDu wurdest von §b%§a in seine Skyblock-Part eingeladen. Wenn du annehmen möchtest§7 /Skyblock party annehmen"),
