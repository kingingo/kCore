...
Wahl_X_FETT("✘"),
HERZ("♥"),
TREASURE_CHEST_TIME_AWAY("§cDie Zeit ist abgelaufen."),
VERSUS_ADDED("Du wurdest auf die Warteliste hinzugefügt"),
VERSUS_PLACE("Du befindest dich auf PLatz §b%"),
BIG_HERZ("❤"),
NO_CHARAKTER("Es sind ungültige Zeichen im Namen!"),
ROTATE_HERZ("❥"),
...
CHAT_MESSAGE_BLOCK("§cBitte unterlasse solche Wörter im Chat!"),
...
MORE_HAND("§aDu hast nun 64x."),
MORE_INV("§aDeine Items im Inventory wurden auf 64x aufgerundet."),
...
FIGHT_START_IN("§eIhr könnt in§b % §eSekunden Kämpfen!"),
FIGHT_START("§cIhr könnt nun Kämpfen!"),
GAME_END_IN("§eDas Spiel endet in§b % §e"),
GAME_END("§cDas Spiel wurde beendet."),
RESTART_IN("§4Der Server Restartet in§b % §4Sekunden"),
RESTART("§4§lDer Server Restartet Jetzt"),
SERVER_FULL("§cDer Server ist voll!"),
SERVER_NOT_LOBBYPHASE("§cDieser Server ist aktuell nicht in der Lobbyphase!"),
...
GAME_EXCLUSION("§c% wurde vom Spiel ausgeschlossen"),
...
KICKED_BY_PREMIUM("§cDu wurdest vom Server gekickt damit ein Premium User spielen kann. Du möchtest auch? §bshop.EpicPvP.de"),
PREFIX_GAME("§7[§6%§7]: §7"),
PREFIX("§7[§6EpicPvP§7]: §7"),
...
GAME_START("§eDas Spiel ist gestartet"),
GAME_START_IN("§eDas Spiel startet in§b %§e Sekunden"),
DEATHMATCH_START("§cDas Deathmatch startet"),
DEATHMATCH_START_IN("§cDas Deathmatch startet in §b% §cSekunden"),
DEATHMATCH_END("Das Deathmatch ist zu ende."),
GAME_WIN("§eDer Spieler §b% §ehat das Spiel gewonnen!"),
SURVIVAL_GAMES_DISTRICT_WIN("§eDas District§a % §emit den Spielern§b %§e und§b % §ehat Gewonnen"),
DEATHMATCH_END_IN("§cDas Deathmatch endet in §b%§c Sekunden"),
...
TTT_DNA_TEST("§eDer DNA-TEST hat er geben ,dass der Spieler %§e von %§e getötet wurde."),
...
SHEEPWARS_SHEEP_DEATH("§eTeam %§e hat ihr Schaf verloren!"),
BEDWARS_BED_BROKE("§eTeam %§e hat ihr Bed verloren!"),
...
SKYBLOCK_PLAYER_KICK("§aDu hast den Spieler §c%§a von deiner Insel gekickt."),
SKYBLOCK_PLAYER_KICKED("§cDu wurdest von §4%§c von seiner Insel gekickt."),
SKYBLOCK_PLAYER_NOT_ON_YOUR_ISLAND("§aDer Spieler §c%§a ist nicht auf deiner Insel."),
...
SKYBLOCK_REMOVE_ISLAND_ONE("§cDu kannst nur einmal am Tag deine Insel löschen oder als Ultra eine Gilden Insel erstellen!"),
...
kFLY_NOT_ON("§cFly ist nicht aktiviert!"),
NO_INTEGER("§cDas ist keine Zahl."),
kFLY_SPEED("§aFly speed wurde auf §b%§a geändert"),
...
VANISH_AN("§aVanish wurde aktiviert."),
VANISH_AUS("§cVanish wurde deaktiviert."),
