...
PERK_HEALBYHIT(new String[]{"% Prozent Chance ein % Herz zu bekommen wenn du deinen Gegner schlägst."}),
...
PERK_MOREHEALTH(new String[]{"Immer wenn du nur noch % Herzen hast erhält dein Geger denn % Prozent Schaden "}),
