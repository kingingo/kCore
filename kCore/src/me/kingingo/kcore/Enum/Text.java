...
TTT_PÄSSE_USE("§eDu hast einen§b %§e Pass benutzt du hast jetzt noch§b %!"),
TTT_PÄSSE_KEINE("§eDu besitzt keine % Pässe!"),
TTT_PÄSSE_LOBBYPHASE("§eDie LobbyPhase ist vorbei..."),
TTT_PÄSSE_MAX_USED("§eEs wurden schon zu viele §b%§e Pässe benutzt"),
...
GILDE_CREATE("Die Gilde % wurde erstellt."),
GILDE_PLAYER_OFFLINE("Der Spieler % ist Offline."),
GILDE_PREFIX("§6[Gilde]:§7 "),
GILDE_PLAYER_GO_OUT("% hat die Gilde verlassen."),
GILDE_PLAYER_LEAVE("% ist hat den Server verlassen."),
GILDE_PLAYER_IS_IN_GILDE("Du bist bereits in einer Gilde"),
GILDE_PLAYER_IS_NOT_IN_GILDE("Du bist in keiner Gilde"),
GILDE_IS_NOT_IN_THE_GILD("Der Spieler % ist nicht in deiner Gilde"),
GILDE_OWNER_NOT("Du bist nicht der Owner der Gilde."),
GILDE_PLAYER_ENTRE("% ist der Gilde beigetretten."),
GILDE_NAME_LENGTH_MIN("Der Gilden Name muss länger als % Zeichen sein."),
GILDE_NAME_LENGTH_MAX("Der Gilden Name muss kleiner als % Zeichen sein."),
GILDE_EXIST("Diese Gilde exestiert bereits!"),
GILDE_EXIST_NOT("Diese Gilde exestiert nicht!"),
GILDE_DELETE("Die Gilde % wurde gelöscht."),
GILDE_EINLADEN("Du hast % in die Gilde eingeladen"),
GILDE_EILADUNG("Du wurdest in die Gilde % eingeladen"),
GILDE_CLOSED("Die Gilde wurde geschlossen."),
GILDE_KICK_PLAYER("Der Spieler % wurde aus der Gilde gekickt."),
GILDE_SETHOME("Das Gild Home wurde gesetzt"),
GILDE_TELEPORT_CANCELLED("Die Teleportation wurde abgebrochen."),
GILDE_HOME("Du wirst in % sekunden Teleportiert..."),
GILDE_PLAYER_NICHT_EINGELADEN("Du hast keine Einladung in eine Gilde erhalten"),
GILDE_PLAYER_JOIN("% hat den Server betretten."),
FRIEND_PREFIX("§6[Friend]:§7 "),
FRIEND_EXIST("Du bist bereits mit den Spieler % Befreundet."),
FRIEND_SEND("Du hast den Spieler % eine freundschaftsanfrage gesendet."),
FRIEND_NOT("Du bist nicht mit % befreundet."),
FRIEND_DEL("Du bist nun mit % nicht mehr Befreundet."),
FRIEND_DEL_IN("In % sekunden wird die Freundschaft mit % aufgelöst."),
...
FRIEND_YOURE_SELF("Du kannst nicht mit dir selber befreundet sein!"),
