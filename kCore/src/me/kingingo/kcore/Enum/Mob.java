...
public enum Mob
{
  ...
  private Mob(String n, Enemies en, String s, EntityType type) { this.suffix = s;
    this.name = n;
    this.type = en;
  ...
  public Entity spawn(World world, Server server, Location loc) throws Mob.MobException
  {
    Entity entity = world.spawn(loc, this.bukkitType.getEntityClass());
    if (entity == null)
    {
      logger.log(Level.WARNING, "Mob nicht gespawnt!");
