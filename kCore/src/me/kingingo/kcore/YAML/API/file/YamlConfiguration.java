package me.kingingo.kcore.YAML.API.file;
...
import me.kingingo.kcore.YAML.API.Configuration;
import me.kingingo.kcore.YAML.API.ConfigurationSection;
import me.kingingo.kcore.YAML.API.InvalidConfigurationException;
...
public class YamlConfiguration extends FileConfiguration {
    ...
    public static YamlConfiguration loadConfiguration(File file) {
        ...
        try {
            ...
            System.out.println("YAML Error! cannot load" + file);
    ...
    public static YamlConfiguration loadConfiguration(InputStream stream) {
        ...
        try {
        	...
        	System.out.println("YAML Error! cannot load stream");
        } catch (InvalidConfigurationException ex) {
        	System.out.println("YAML Error! cannot load stream");
        }
