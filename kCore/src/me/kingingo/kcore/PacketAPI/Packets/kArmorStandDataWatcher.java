...
public class kArmorStandDataWatcher extends kDataWatcher{
	
	public kArmorStandDataWatcher(Entity entity) {
		super(entity);
		initialize();
	}
	
	public kArmorStandDataWatcher(World world){
		super(world);
		initialize();
	}
	
	public kArmorStandDataWatcher(){
		initialize();
	}
