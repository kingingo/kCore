...
public class DeliveryObject {
 ...
 public DeliveryObject(String[] description,kPermission permission,boolean byClickBlock,int slot,String displayname,Material material,Material delay_material,Click click,long time){
 ...
 public DeliveryObject(String[] description,kPermission permission,boolean byClickBlock,int slot,String displayname,Material material,int data,Material delay_material,int delay_data,Click click,long time){
